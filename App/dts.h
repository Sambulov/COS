...
#define DTS_H_
  ...
  extern hdl_clock_counter_t dts_timer0_counter;
  ...
  // extern const hdl_gpio_pin_t dts_gpi_carrier_sleep;
  // extern const hdl_gpio_pin_t dts_gpi_carrier_wdt_time_out;
