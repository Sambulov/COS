...
typedef uint8_t (*hdl_interrupt_request_t)(const hdl_module_base_t *, const hdl_interrupt_t *);
typedef void (*hdl_interrupt_sw_trigger_t)(const hdl_module_base_t *, const hdl_interrupt_t *);
...
extern hdl_module_base_iface_t hdl_core_iface;
...
__STATIC_INLINE void hdl_interrupt_sw_trigger(const hdl_module_base_t *ic, const hdl_interrupt_t *isr) {
  ((hdl_interrupt_controller_iface_t *)ic->iface)->trigger(ic, isr);
}
