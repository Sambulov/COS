...
typedef enum {
  ...
  HDL_I2C_MESSAGE_WRITE_STOP     = HDL_I2C_MESSAGE_START | HDL_I2C_MESSAGE_ADDR | HDL_I2C_MESSAGE_STOP,
  HDL_I2C_MESSAGE_WRITE_HALT     = HDL_I2C_MESSAGE_START | HDL_I2C_MESSAGE_ADDR,
  HDL_I2C_MESSAGE_READ_STOP      = HDL_I2C_MESSAGE_START | HDL_I2C_MESSAGE_ADDR | HDL_I2C_MESSAGE_MRSW | HDL_I2C_MESSAGE_NACK_LAST | HDL_I2C_MESSAGE_STOP,
  HDL_I2C_MESSAGE_READ_HALT      = HDL_I2C_MESSAGE_START | HDL_I2C_MESSAGE_ADDR | HDL_I2C_MESSAGE_MRSW,
  HDL_I2C_MESSAGE_BUS_RESET      = HDL_I2C_MESSAGE_START | HDL_I2C_MESSAGE_STOP
