...
typedef uint32_t (*hdl_entropy_poll_t)(const void *desc, uint8_t *output, uint32_t amount);
...
__STATIC_INLINE uint32_t hdl_entropy_poll(const void *desc, uint8_t *output, uint32_t amount) {
