...
void EXTI5_9_IRQHandler()               { uint32_t src = (EXTI_PD & EXTI_LINES_5_9); call_isr( HDL_NVIC_IRQ23_EXTI5_9, (void *)src); EXTI_PD |= src; }
void TIMER0_BRK_TIMER8_IRQHandler()     { call_isr( HDL_NVIC_IRQ24_TIMER0_BRK_TIMER8, (void *)TIMER_INTF(TIMER8)); 
                                          TIMER_INTF(TIMER0) &= ~TIMER_INTF_BRKIF;
                                          TIMER_INTF(TIMER8) &= ~TIMER_INTF(TIMER8);
                                        }
void TIMER0_UP_TIMER9_IRQHandler()      { call_isr(HDL_NVIC_IRQ25_TIMER0_UP_TIMER9, (void *)TIMER_INTF(TIMER9));
                                          TIMER_INTF(TIMER0) &= ~TIMER_INTF_UPIF;
                                          TIMER_INTF(TIMER9) &= ~(TIMER_INTF(TIMER9));
                                        }
void TIMER0_TRG_CMT_TIMER10_IRQHandler(){ call_isr( HDL_NVIC_IRQ26_TIMER0_TRG_CMT_TIMER10, (void *)TIMER_INTF(TIMER10));
...
void TIMER1_IRQHandler()                { call_isr(HDL_NVIC_IRQ28_TIMER1, (void *)TIMER_INTF(TIMER1));
                                          TIMER_INTF(TIMER1) &= ~TIMER_INTF(TIMER1);
                                        }
void timer2_handler()                   { call_isr( HDL_NVIC_IRQ29_TIMER2, (void *)TIMER_INTF(TIMER2)); TIMER_INTF(TIMER2) &= ~TIMER_INTF(TIMER2); }
void TIMER3_IRQHandler()                { call_isr( HDL_NVIC_IRQ30_TIMER3, (void *)TIMER_INTF(TIMER3)); TIMER_INTF(TIMER3) &= ~TIMER_INTF(TIMER3); }
...
void EXTI10_15_IRQHandler()             { uint32_t src = (EXTI_PD & EXTI_LINES_10_15); call_isr( HDL_NVIC_IRQ40_EXTI10_15, (void *)src); EXTI_PD |= src; }
...
void TIMER7_Channel_IRQHandler()        { call_isr( HDL_NVIC_IRQ46_TIMER7_Channel, (void *)TIMER_INTF(TIMER7)); TIMER_INTF(TIMER7) &= ~TIMER_INTF(TIMER7); }
...
void TIMER4_IRQHandler()                { call_isr( HDL_NVIC_IRQ50_TIMER4, (void *)TIMER_INTF(TIMER4)); TIMER_INTF(TIMER4) &= ~TIMER_INTF(TIMER4); }
...
void TIMER6_IRQHandler()                { call_isr( HDL_NVIC_IRQ55_TIMER6, (void *)TIMER_INTF(TIMER6)); TIMER_INTF(TIMER6) &= ~TIMER_INTF(TIMER6); }
