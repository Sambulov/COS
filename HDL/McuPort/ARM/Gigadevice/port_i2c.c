...
static void _i2c_reg_set_wait_condition(hdl_i2c_mcu_t *i2c, __IO uint32_t *reg, uint32_t flags, uint8_t is_set, uint32_t timeout) {
  hdl_i2c_var_t *i2c_var = (hdl_i2c_var_t *)i2c->obj_var;
...
static void _i2c_reg_wait_condition(hdl_i2c_mcu_t *i2c) {
  hdl_i2c_var_t *i2c_var = (hdl_i2c_var_t *)i2c->obj_var;
...
static hdl_i2c_message_status_t _i2c_msg_stop_handler(hdl_i2c_mcu_t *i2c) {
  hdl_i2c_var_t *i2c_var = (hdl_i2c_var_t *)i2c->obj_var;
  hdl_i2c_config_hw_t *hwc = (hdl_i2c_config_hw_t *)i2c->config->hwc;
  i2c_periph_t *i2c_periph = (i2c_periph_t *)hwc->phy;
  if(i2c_var->wrk_state_substate == 1) {
  ...
  if(i2c_var->wrk_state_substate == 2) {
    ...
    i2c_ack_config(((uint32_t)hwc->phy), (i2c_var->ch_amount)? I2C_ACK_ENABLE: I2C_ACK_DISABLE);
    i2c_periph->CTL1 |= (I2C_CTL1_BUFIE | I2C_CTL1_EVIE | I2C_CTL1_ERRIE);
...
static hdl_module_state_t _hdl_i2c(const void *desc, uint8_t enable) {
  ...
  hdl_i2c_config_hw_t *hwc = (hdl_i2c_config_hw_t *)i2c->config->hwc;
  i2c_periph_t *i2c_periph = (i2c_periph_t *)hwc->phy;
  i2c_deinit((uint32_t)hwc->phy);
  if(enable) {
    rcu_periph_clock_enable(hwc->rcu);
    i2c_clock_config((uint32_t)hwc->phy, hwc->speed, hwc->dtcy);
    ...
    for(uint32_t no = 0, ch = 0; no < 2; no++) {
      ...
      if(no == 0) {
        i2c_mode_addr_config((uint32_t)hwc->phy, I2C_I2CMODE_ENABLE, 
...
static uint8_t _hdl_i2c_set_transceiver(const void *desc, const hdl_transceiver_t *transceiver, uint32_t channel) {
  hdl_i2c_mcu_t *i2c = (hdl_i2c_mcu_t *)desc;
...
const hdl_i2c_iface_t hdl_i2c_iface = {
  ...
  .transceiver_set = &_hdl_i2c_set_transceiver
};
