...
// #define HXTAL_MAX_FREQ            24000000UL
...
//       if(_hdl_clock_pll_init(hdl_prescaler, -1, (hdl_prescaler->muldiv_factor << 6), 6, 14, &hdl_clock_selector_pll_vco) == HDL_MODULE_ACTIVE)
