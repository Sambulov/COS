...
void GPA_IRQHandler()        { uint32_t src = GPA->INTSRC; call_isr(HDL_NVIC_IRQ16_GPA_IRQn, (void *)src); GPA->INTSRC |= src; }
void GPB_IRQHandler()        { uint32_t src = GPB->INTSRC; call_isr(HDL_NVIC_IRQ17_GPB_IRQn, (void *)src); GPB->INTSRC |= src;  }
void GPC_IRQHandler()        { uint32_t src = GPC->INTSRC; call_isr(HDL_NVIC_IRQ18_GPC_IRQn, (void *)src); GPC->INTSRC |= src; }
void GPD_IRQHandler()        { uint32_t src = GPD->INTSRC; call_isr(HDL_NVIC_IRQ19_GPD_IRQn, (void *)src); GPD->INTSRC |= src; }
void GPE_IRQHandler()        { uint32_t src = GPE->INTSRC; call_isr(HDL_NVIC_IRQ20_GPE_IRQn, (void *)src); GPE->INTSRC |= src; }
void GPF_IRQHandler()        { uint32_t src = GPF->INTSRC; call_isr(HDL_NVIC_IRQ21_GPF_IRQn, (void *)src); GPF->INTSRC |= src; }
...
void GPJ_IRQHandler()        { uint32_t src = GPJ->INTSRC; call_isr(HDL_NVIC_IRQ61_GPJ_IRQn, (void *)src); GPJ->INTSRC |= src; }
...
void GPG_IRQHandler()        { uint32_t src = GPG->INTSRC; call_isr(HDL_NVIC_IRQ72_GPG_IRQn, (void *)src); GPG->INTSRC |= src; }
...
void GPH_IRQHandler()        { uint32_t src = GPH->INTSRC; call_isr(HDL_NVIC_IRQ88_GPH_IRQn, (void *)src); GPH->INTSRC |= src; }
...
void GPI_IRQHandler()        { uint32_t src = GPI->INTSRC; call_isr(HDL_NVIC_IRQ110_GPI_IRQn, (void *)src); GPI->INTSRC |= src; }
