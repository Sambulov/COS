...
typedef enum {
  HDL_CLOCK_TYPE_HXTAL,          /* property: freq (can be 3 ~ 25MHz)*/
  ...
  HDL_CLOCK_TYPE_PLL,            /* property: mul (can be 2, 3, 4 .. 16), module depends on PLL_SEL */
  ...
  //HDL_CLOCK_TYPE_ADC,            /* property: div (can be 2, 4, 6, 8), module depends on HDL_CLOCK_TYPE_APB2 */
} hdl_clock_type_t;
