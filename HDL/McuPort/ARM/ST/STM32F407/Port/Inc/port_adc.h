...
typedef enum {
    ...
    HDL_ADC_CHANNEL_16 = ADC_CHANNEL_16, /* Temperature sensor */
    HDL_ADC_CHANNEL_17 = ADC_CHANNEL_17, /* TSVREFE channel */
    HDL_ADC_CHANNEL_18 = ADC_CHANNEL_18, /* VBAT channel */
} hdl_adc_channel_e;

typedef enum{
    HDL_ADC_SAMPLETIME_3   = ADC_SAMPLETIME_3CYCLES,
    HDL_ADC_SAMPLETIME_15  = ADC_SAMPLETIME_15CYCLES,
    HDL_ADC_SAMPLETIME_28  = ADC_SAMPLETIME_28CYCLES,
    HDL_ADC_SAMPLETIME_56  = ADC_SAMPLETIME_56CYCLES,
    HDL_ADC_SAMPLETIME_84  = ADC_SAMPLETIME_84CYCLES,
    HDL_ADC_SAMPLETIME_112 = ADC_SAMPLETIME_112CYCLES,
    HDL_ADC_SAMPLETIME_144 = ADC_SAMPLETIME_144CYCLES,
    HDL_ADC_SAMPLETIME_480 = ADC_SAMPLETIME_480CYCLES
