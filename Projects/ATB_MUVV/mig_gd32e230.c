...
*/
  ...
  #define HDL_RTC_CLOCK                mod_clock_hxtal           /* Can be clocked by: mod_clock_hxtal, mod_clock_lxtal, mod_clock_irc40k. For mod_clock_hxtal applied prediv 32 */
  ...
  #define HDL_SYS_CLOCK                mod_clock_pll             /* Can be clocked by: mod_clock_irc8m, mod_clock_pll, mod_clock_hxtal */
...
hdl_gpio_pin_t mod_gpi_button = {
  ...
  .config = hdl_gpio_pin_config(.inactive_default = HDL_GPIO_HIGH, .hwc = &mod_gpio_input_pullup_mode)
};
...
hdl_gpio_pin_t mod_gpio_i2c0_scl = {
  ...
  .config = hdl_gpio_pin_config(.inactive_default = HDL_GPIO_LOW, .hwc = &mod_gpio_i2c_0_mode)
};
...
hdl_gpio_pin_t mod_gpio_i2c1_scl = {
  ...
  .config = hdl_gpio_pin_config(.inactive_default = HDL_GPIO_LOW, .hwc = &mod_gpio_i2c_1_mode)
};
