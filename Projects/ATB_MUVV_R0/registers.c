...
volatile reg_t g_i2c_reg_data[] =
{
		...
		[ID1_RO] = 	        { READ_ONLY, 	REG_ID1_ADDR,       ID1,    {.uint32_val = 0x0}, 	{0} },
		[ID2_RO] = 	        { READ_ONLY, 	REG_ID2_ADDR,       ID2,    {.uint32_val = 0x0}, 	{0} },
		[ID3_RO] = 	        { READ_ONLY, 	REG_ID3_ADDR,       ID3,    {.uint32_val = 0x0}, 	{0} },
