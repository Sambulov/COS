...
static void _bldl_uspd_ain_port_set_circuit(hdl_uspd_ain_port_private_t *port, hdl_uspd20k_circuit_cofig_t cnf) {
  ...
  _uspd_ain_port_set_circuit_pin((hdl_gpio_pin_t *)port->module.dependencies[1], (cnf & USPD20K_CIRCUIT_CONFIG_CUR_SRC) != 0);
  _uspd_ain_port_set_circuit_pin((hdl_gpio_pin_t *)port->module.dependencies[2], (cnf & USPD20K_CIRCUIT_CONFIG_OPAMP_2_5) != 0);
