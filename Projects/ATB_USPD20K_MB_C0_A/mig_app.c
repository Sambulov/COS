...
bldl_uspd_ain_port_t app_uspd_ain_port[APP_AIN_PORTS_AMOUNT] = {
  {
    ...
    .module.dependencies = hdl_module_dependencies(
      &uspd20k_ai1_ntc_pu.module, &uspd20k_ai1_cur_scr.module, &uspd20k_ai1_op_amp.module,
  ...
  },
  {
    .module.init = &bldl_uspd_ain_port,
    .module.dependencies = hdl_module_dependencies(
      &uspd20k_ai2_ntc_pu.module, &uspd20k_ai2_cur_scr.module, &uspd20k_ai2_op_amp.module,
  ...
  },
  {
    .module.init = &bldl_uspd_ain_port,
    .module.dependencies = hdl_module_dependencies(
      &uspd20k_ai3_ntc_pu.module, &uspd20k_ai3_cur_scr.module, &uspd20k_ai3_op_amp.module,
  ...
  },
  {
    .module.init = &bldl_uspd_ain_port,
    .module.dependencies = hdl_module_dependencies(    
      &uspd20k_ai4_ntc_pu.module, &uspd20k_ai4_cur_scr.module, &uspd20k_ai4_op_amp.module,
...
const app_adc_config_preset_t app_adc_rtd_preset = {
  ...
  .circuit_config = USPD20K_CIRCUIT_CONFIG_CUR_SRC
};
...
const app_adc_config_preset_t app_adc_ain_calib_preset = {
  .ch_config.config_reg = MS5194T_CONFIG_REG_VBIAS_DISBL | !MS5194T_CONFIG_REG_BO | MS5194T_CONFIG_REG_UB | 
                          ...
                          !MS5194T_CONFIG_REG_REF_DET | MS5194T_CONFIG_REG_BUF, // | MS5194T_CONFIG_REG_CH_SEL(),
  .ch_config.options = HDL_ADC_MS5194T_CHANNEL_ENABLE | HDL_ADC_MS5194T_CHANNEL_ZERO_SCALE_CALIBRATE | HDL_ADC_MS5194T_CHANNEL_FULL_SCALE_CALIBRATE,
  .circuit_config = USPD20K_CIRCUIT_CONFIG_1K_PD | USPD20K_CIRCUIT_CONFIG_CUR_SRC
};
