...
#define HDL_I2C_SLAVE_ADDR           0x52
...
hdl_tick_counter_t mod_systick_counter = {
  ...
  .config.systick = hdl_module_config(hdl_tick_counter_systick_config_t, .period = HDL_SYSTICK_COUNTER_RELOAD)
};
...
hdl_gpio_pin_t mod_pin_i2c0_scl = {
...
hdl_gpio_pin_t mod_pin_i2c0_sda = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
...
hdl_gpio_pin_t uspd20k_io1_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_14,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PB14)
hdl_gpio_pin_t uspd20k_io1_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_5,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PB5)
hdl_gpio_pin_t uspd20k_io1_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
...
hdl_gpio_pin_t uspd20k_io2_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_13,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PB13)
hdl_gpio_pin_t uspd20k_io2_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_10,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PA10)
hdl_gpio_pin_t uspd20k_io2_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_5,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
...
hdl_gpio_pin_t uspd20k_io3_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_8,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PA8)
hdl_gpio_pin_t uspd20k_io3_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_4,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PB4)
hdl_gpio_pin_t uspd20k_io3_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
...
hdl_gpio_pin_t uspd20k_io4_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_15,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PB15)
hdl_gpio_pin_t uspd20k_io4_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_11,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PA11)
hdl_gpio_pin_t uspd20k_io4_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_4,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
...
hdl_gpio_pin_t uspd20k_io5_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_12,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PB12)
hdl_gpio_pin_t uspd20k_io5_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_3,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PB3)
hdl_gpio_pin_t uspd20k_io5_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_1,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
...
hdl_gpio_pin_t uspd20k_io6_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_9,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PA9)
hdl_gpio_pin_t uspd20k_io6_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_12,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PA12)
hdl_gpio_pin_t uspd20k_io6_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_2,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
...
hdl_gpio_pin_t uspd20k_io7_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_10,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PB10)
hdl_gpio_pin_t uspd20k_io7_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
  .module.reg = (void *)GPIO_PIN_15,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PA15)
hdl_gpio_pin_t uspd20k_io7_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_0,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
...
hdl_gpio_pin_t uspd20k_io8_di_disable = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_11,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_output_pp_mode, .inactive_default = HDL_GPIO_LOW)
};   // (PB11)
hdl_gpio_pin_t uspd20k_io8_di = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_b.module),
  .module.reg = (void *)GPIO_PIN_6,
  .config = hdl_gpio_pin_config(.hwc = &mod_gpio_input_pullup_mode, .inactive_default = HDL_GPIO_HIGH)
};   // (PB6)
hdl_gpio_pin_t uspd20k_io8_do = {
  .module.init = &hdl_gpio_pin,
  .module.dependencies = hdl_module_dependencies(&hdl_gpio_port_a.module),
...
hdl_i2c_t mod_i2c0 = {
  .module.init = &hdl_i2c,
  .module.dependencies = hdl_module_dependencies(&mod_pin_i2c0_scl.module, &mod_pin_i2c0_sda.module,
